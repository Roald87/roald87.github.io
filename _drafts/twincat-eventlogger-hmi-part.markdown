...
![](/assets/2021-twincat-event-logger-hmi-part/add_hmi_project.png)
...
![](/assets/2021-twincat-event-logger-hmi-part/default_hmi_project.png)
...
![](/assets/2021-twincat-event-logger-hmi-part/add_event_grid.gif)
...
![](/assets/2021-twincat-event-logger-hmi-part/ads_runtime_config.png)
...
![](/assets/2021-twincat-event-logger-hmi-part/event_target.png)
...
![](/assets/2021-twincat-event-logger-hmi-part/send_message_button.png)
...
![](/assets/2021-twincat-event-logger-hmi-part/map_symbol.png)
...
![](/assets/2021-twincat-event-logger-hmi-part/live-view_errors.png)

## Adding the other alarms

Very similarly to how we created a button to send a message, we can now add some more buttons to raise, clear and confirm the other two alarms in the project. For each button I labelled them to which variable in the PLC they are linked.

![](/assets/2021-twincat-event-logger-hmi-part/all_alarms_annotated.png)
...
## Pop-ups
The event grid is provides a convinient interface for all events. However, it is easy to miss a newly raised alarm. Especially if you have multiple HMI pages, of which maybe not all contain an event grid control. A good way to grab the user’s attention is through pop-ups. 
